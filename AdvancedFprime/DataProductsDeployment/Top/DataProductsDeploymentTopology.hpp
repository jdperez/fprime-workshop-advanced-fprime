// ======================================================================
// \title  DataProductsDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef DATAPRODUCTSDEPLOYMENT_DATAPRODUCTSDEPLOYMENTTOPOLOGY_HPP
#define DATAPRODUCTSDEPLOYMENT_DATAPRODUCTSDEPLOYMENTTOPOLOGY_HPP
// Included for access to DataProductsDeployment::TopologyState and DataProductsDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <AdvancedFprime/DataProductsDeployment/Top/DataProductsDeploymentTopologyDefs.hpp>

// Remove unnecessary DataProductsDeployment:: qualifications
using namespace DataProductsDeployment;
namespace DataProductsDeployment {
/**
 ...
 * DataProductsDeployment::TopologyState see: DataProductsDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type DataProductsDeployment::TopologyState see: DataProductsDeploymentTopologyDefs.hpp.
 *
