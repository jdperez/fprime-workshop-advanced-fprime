module DataProductsDeployment {
  ...
  topology DataProductsDeployment {
  ...
  # ----------------------------------------------------------------------
    ...
    # include "DataProductsDeploymentPackets.fppi"
  ...
  # ----------------------------------------------------------------------
    ...
    connections RateGroups {
      ...
      rateGroup3.RateGroupMemberOut[5] -> Bmp280.bmpManager.run
    }
    ...
    connections DataProductsDeployment {
        Bmp280.bmpManager.bmpDataPush -> bmpReader.Bmp280In
        bmpReader.productGetOut  -> DataProducts.dpMgr.productGetIn
        bmpReader.productSendOut -> DataProducts.dpMgr.productSendIn
    }
