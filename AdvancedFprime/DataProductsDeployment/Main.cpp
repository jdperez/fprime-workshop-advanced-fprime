...
#include <AdvancedFprime/DataProductsDeployment/Top/DataProductsDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
static void signalHandler(int signum) {
    DataProductsDeployment::stopRateGroups();
}
...
int main(int argc, char* argv[]) {
    ...
    DataProductsDeployment::TopologyState inputs;
    ...
    DataProductsDeployment::setupTopology(inputs);
    DataProductsDeployment::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    DataProductsDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
